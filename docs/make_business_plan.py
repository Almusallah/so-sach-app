...
def build(lang, filename):
    ...
    s.append(Paragraph(
        ("Vietnam has manufactured a once-in-a-decade compliance shock: from 1 January 2026 the lump-sum "
         ...
         "now carried in Decree 254/2026, in force since 01/07/2026). "
        ...
        ("Il Vietnam ha fabbricato lo shock di compliance del decennio: dal 1° gennaio 2026 il regime "
         ...
         "fisco (Decreto 70/2025, oggi confluito nel Decreto 254/2026, in vigore dal 01/07/2026). "
         "I software incumbent (MISA, KiotViet, Sapo) registrano le transazioni; "
